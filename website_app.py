        ...
        if topic=='Pandas':
            ...
            with st.container():
                ...
                with text_col:
                    ...
                    st.markdown("By Sharone Li - As a data scientist, you must have encountered this problem at least once in your data science journey: you import your data into a Pandas dataframe... [Continue to Read on Towards Data Science](https://drive.google.com/file/d/1o4xCYn6x3r4yJ964VaIjeKx5HMUJnZhf/view?usp=sharing)")
            ...
            with st.container():
                ...
                with text_col:
                    ...
                    st.markdown("By Sharone Li - If you have been following my Medium blog for some time, you may notice that I usually like to share... [Continue to Read on CodeX](https://acrobat.adobe.com/link/review?uri=urn:aaid:scds:US:8552d95f-2317-4b8d-a1c7-2b22e7aa7dfa)")
